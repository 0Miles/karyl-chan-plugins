import type { Manifest, PluginManifestV2 } from "./manifest.js";
...
export interface PluginClientOptions {
  botUrl: string;
  setupSecret: string;
  /** v2 manifest（PluginManifestV2）或 v1 manifest（Manifest，@deprecated）。 */
  manifest: PluginManifestV2 | Manifest;
...
export interface PluginClient {
   ...
   * `verifyPluginSession`). Null until first register, or if the bot is
   * too old to send it.
   */
