...
| id        | invariant                                                | trigger                                                          | expected                                                              | target file/line  |
|-----------|----------------------------------------------------------|------------------------------------------------------------------|-----------------------------------------------------------------------|-------------------|
| persist-001 | game state does NOT survive container restart            | start game; `docker compose restart karyl-avalon-plugin`         | `getGame(channelId)` empty after restart; any prior buttons return `error.notRunning`; **no half-state crash** | `store.ts:13-29`  |
