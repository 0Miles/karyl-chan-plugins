...
export const zhTW = {
  ...
  "stage.signup.ladyOn": "已啟用湖中女神。",
  "stage.signup.ladyOff": "已停用湖中女神。",
  "stage.signup.ladyNeeds7": "需要 7 人以上才能啟用湖中女神。",
  "stage.signup.fieldNpcRoster": "NPC 名單",
  "stage.signup.fieldNpcCount": "NPC 人數",
  "stage.signup.npcAdd": "+ NPC",
  "stage.signup.npcRemove": "− NPC",
  "stage.signup.npcAdded": "已加入 1 名 NPC：{name}。",
  "stage.signup.npcRemoved": "已移除 1 名 NPC。",
  "stage.signup.npcAtMax": "已達總人數上限。",
  "stage.signup.npcAtMin": "沒有 NPC 可移除。",
  "stage.signup.npcLineSuffix": "（NPC）",
  "stage.signup.joinedEvictedNpc": "已加入；同時移除一名 NPC 以騰出名額。",
